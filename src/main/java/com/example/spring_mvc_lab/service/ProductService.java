...
public class ProductService {
    ...
    public ProductService() {
        ...
        products.add(new Product(1L, "Laptop ASUS", "Elektronik", 12500000, 15));
        products.add(new Product(2L, "Mouse Logitech", "Elektronik", 350000, 50));
        products.add(new Product(3L, "Buku Java Programming", "Buku", 150000, 30));
        products.add(new Product(4L, "Kopi Arabica 250g", "Makanan", 85000, 100));
